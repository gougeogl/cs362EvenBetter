...
*				TributeRevealedCards Not Discarded
*
**************************************************/
#include <stdio.h>
#include <math.h>
...
int main()
{
	...
	cardInDeck = copper;
	subTestTribute7B(1, test_1_message, &backup, &G, newHandSize, tribute_index, cardInDeck);
	runAsserts7B(&backup,&G);
	printf("------------------------------------------------------------------------------------\n");
...
/* ** ASSERTS SECTION ** */
/* MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM */
void runAsserts7B(struct gameState* before, struct gameState* after)
{
